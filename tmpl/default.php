...
if($ANZEIGEFAELLEGESAMT == 1) 
   {
   echo '<p>Gesamtf&auml;lle: <span id='.'"' . anzeigeFaelleGesamt . '"' . '></span></p>';
   }
if($ANZEIGEFAELLETOD == 1) 
   {
   echo '<p>Todesf&auml;lle: <span id='.'"' . anzeigeFaelleTod . '"' . '></span></p>';
   }
...
if($ANZEIGEFAELLEPRO100K == 1) 
   {
   echo '<p>Gesamt&auml;lle pro 100.000: <span id='.'"' . anzeigeFaellePro100k . '"' . '></span></p>';
   }
